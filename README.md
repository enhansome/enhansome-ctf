...
Please take a quick look at the [contribution guidelines](https://github.com/apsdehal/ctf-tools/blob/master/CONTRIBUTING.md) ⭐ 11,842 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 first.
...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,965 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,831 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
...
* [echoCTF.RED](https://github.com/echoCTF/echoCTF.RED) ⭐ 150 | 🐛 11 | 🌐 PHP | 📅 2026-09-11 - Develop, deploy and maintain your own CTF infrastructure.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 38,984 | 🐛 606 | 🌐 Ruby | 📅 2026-09-11
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,969 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,118 | 🐛 3 | 🌐 Python | 📅 2026-09-11 - A tool for recovering RSA private key with various attack.
* [RSATool](https://github.com/ius/rsatool) ⭐ 1,660 | 🐛 2 | 🌐 Python | 📅 2026-07-20 - Generate private key with knowledge of p and q.
...
* [FeatherDuster](https://github.com/nccgroup/featherduster) ⭐ 1,135 | 🐛 28 | 🌐 Python | 📅 2021-12-02 - An automated, modular cryptanalysis tool.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,618 | 🐛 515 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
* [Patator](https://github.com/lanjelot/patator) ⭐ 3,929 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,689 | 🐛 120 | 🌐 Python | 📅 2026-09-03 - CTF Framework for writing exploits.
...
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,349 | 🐛 0 | 🌐 Ruby | 📅 2026-09-11 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,001 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,428 | 🐛 446 | 🌐 Java | 📅 2026-09-08 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,778 | 🐛 824 | 🌐 C | 📅 2026-09-11 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,332 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,656 | 🐛 49 | 🌐 C++ | 📅 2026-09-11 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,855 | 🐛 227 | 🌐 Python | 📅 2026-09-11 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,380 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
* [Angr](https://github.com/angr/angr) ⭐ 9,084 | 🐛 747 | 🌐 Python | 📅 2026-09-11 - platform-agnostic binary analysis framework.
* [GEF](https://github.com/hugsy/gef) ⭐ 8,352 | 🐛 14 | 🌐 Python | 📅 2026-08-20 - GDB plugin.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,238 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Reverse engineer Android applications.
* [PEDA](https://github.com/longld/peda) ⭐ 6,152 | 🐛 76 | 🌐 Python | 📅 2024-07-29 - GDB plugin (only python2.7).
* [Triton](https://github.com/JonathanSalwan/Triton/) ⭐ 4,291 | 🐛 39 | 🌐 C++ | 📅 2026-09-07 - Dynamic Binary Analysis (DBA) framework.
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,084 | 🐛 6 | 🌐 Python | 📅 2026-08-24 - GDB front-end/reverse engineering tool, focused on game-hacking and automation.
...
* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,249 | 🐛 25 | 🌐 Rust | 📅 2026-09-11 - Java decompiler and disassembler.
...
* [Zsteg](https://github.com/zed-0xff/zsteg/) ⭐ 1,624 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - PNG/BMP analysis.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,415 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
...
* [W3af](https://github.com/andresriancho/w3af) ⭐ 4,902 | 🐛 2,032 | 🌐 Python | 📅 2023-02-22 -  Web Application Attack and Audit Framework.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,021 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A high performance offensive security tool for reconnaissance and vulnerability scanning.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 9,020 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
...
* [CTF Tools](https://github.com/zardus/ctf-tools) ⭐ 9,512 | 🐛 2 | 🌐 Nix | 📅 2026-09-09 - Collection of setup scripts to install various security research tools.
