...
Please take a quick look at the [contribution guidelines](https://github.com/apsdehal/ctf-tools/blob/master/CONTRIBUTING.md) ⭐ 11,846 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 first.
...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,968 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,837 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
* [FBCTF](https://github.com/facebook/fbctf) ⚠️ Archived - Platform to host Capture the Flag competitions from Facebook.
* [SecGen](https://github.com/cliffe/SecGen) ⭐ 2,793 | 🐛 37 | 🌐 Python | 📅 2026-08-28 - Security Scenario Generator. Creates randomly vulnerable virtual machines.
* [RootTheBox](https://github.com/moloch--/RootTheBox) ⭐ 1,133 | 🐛 68 | 🌐 Python | 📅 2026-09-03 - A Game of Hackers (CTF Scoreboard & Game Manager).
* [Mellivora](https://github.com/Nakiami/mellivora) ⭐ 450 | 🐛 29 | 🌐 PHP | 📅 2023-12-21 - A CTF engine written in PHP.
...
* [echoCTF.RED](https://github.com/echoCTF/echoCTF.RED) ⭐ 150 | 🐛 8 | 🌐 PHP | 📅 2026-09-13 - Develop, deploy and maintain your own CTF infrastructure.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 39,007 | 🐛 606 | 🌐 Ruby | 📅 2026-09-14
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,977 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,123 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - A tool for recovering RSA private key with various attack.
* [RSATool](https://github.com/ius/rsatool) ⭐ 1,661 | 🐛 2 | 🌐 Python | 📅 2026-07-20 - Generate private key with knowledge of p and q.
* [XORTool](https://github.com/hellman/xortool) ⭐ 1,488 | 🐛 3 | 🌐 Python | 📅 2025-05-21 - A tool to analyze multi-byte xor cipher.
* [Hash Extender](https://github.com/iagox86/hash_extender) ⭐ 1,212 | 🐛 11 | 🌐 C | 📅 2025-01-27 - A utility tool for performing hash length extension attacks.
* [FeatherDuster](https://github.com/nccgroup/featherduster) ⭐ 1,136 | 🐛 28 | 🌐 Python | 📅 2021-12-02 - An automated, modular cryptanalysis tool.
* [padding-oracle-attacker](https://github.com/KishanBagaria/padding-oracle-attacker) ⭐ 218 | 🐛 7 | 🌐 TypeScript | 📅 2023-02-03 - A CLI tool to execute padding oracle attacks.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,626 | 🐛 514 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
* [Patator](https://github.com/lanjelot/patator) ⭐ 3,931 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,695 | 🐛 120 | 🌐 Python | 📅 2026-09-03 - CTF Framework for writing exploits.
* [ROP Gadget](https://github.com/JonathanSalwan/ROPgadget) ⭐ 4,478 | 🐛 15 | 🌐 Python | 📅 2026-06-24 - Framework for ROP exploitation.
* [Qira](https://github.com/BinaryAnalysisPlatform/qira) ⭐ 4,072 | 🐛 70 | 🌐 C | 📅 2022-07-02 - QEMU Interactive Runtime Analyser.
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,351 | 🐛 0 | 🌐 Ruby | 📅 2026-09-11 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
  * `gem install one_gadget`
* [DLLInjector](https://github.com/OpenSecurityResearch/dllinjector) ⭐ 503 | 🐛 1 | 🌐 C++ | 📅 2013-01-07 - Inject dlls in processes.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,012 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,462 | 🐛 446 | 🌐 Java | 📅 2026-09-12 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,797 | 🐛 824 | 🌐 C | 📅 2026-09-14 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,340 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,664 | 🐛 45 | 🌐 C++ | 📅 2026-09-14 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,868 | 🐛 224 | 🌐 Python | 📅 2026-09-14 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,386 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
* [Angr](https://github.com/angr/angr) ⭐ 9,090 | 🐛 734 | 🌐 Python | 📅 2026-09-14 - platform-agnostic binary analysis framework.
* [GEF](https://github.com/hugsy/gef) ⭐ 8,356 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - GDB plugin.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,244 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Reverse engineer Android applications.
* [PEDA](https://github.com/longld/peda) ⭐ 6,152 | 🐛 76 | 🌐 Python | 📅 2024-07-29 - GDB plugin (only python2.7).
* [Triton](https://github.com/JonathanSalwan/Triton/) ⭐ 4,295 | 🐛 39 | 🌐 C++ | 📅 2026-09-12 - Dynamic Binary Analysis (DBA) framework.
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,090 | 🐛 6 | 🌐 Python | 📅 2026-09-13 - GDB front-end/reverse engineering tool, focused on game-hacking and automation.
...
* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,250 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - Java decompiler and disassembler.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,441 | 🐛 31 | 🌐 Python | 📅 2026-09-14 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
...
* [W3af](https://github.com/andresriancho/w3af) ⭐ 4,903 | 🐛 2,032 | 🌐 Python | 📅 2023-02-22 -  Web Application Attack and Audit Framework.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,022 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A high performance offensive security tool for reconnaissance and vulnerability scanning.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 9,031 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
...
* [CTF Tools](https://github.com/zardus/ctf-tools) ⭐ 9,515 | 🐛 2 | 🌐 Nix | 📅 2026-09-09 - Collection of setup scripts to install various security research tools.
...
* [Awesome CTF Cheatsheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet#awesome-ctf-cheatsheet-) ⭐ 141 | 🐛 0 | 📅 2025-04-29 - CTF Cheatsheet.
