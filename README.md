...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,802 | 🐛 426 | 🌐 Python | 📅 2026-08-19 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 38,878 | 🐛 595 | 🌐 Ruby | 📅 2026-08-25
* [Uglify](https://github.com/mishoo/UglifyJS) ⭐ 13,382 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,858 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,097 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - A tool for recovering RSA private key with various attack.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,536 | 🐛 513 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,659 | 🐛 120 | 🌐 Python | 📅 2026-08-16 - CTF Framework for writing exploits.
...
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,346 | 🐛 2 | 🌐 Ruby | 📅 2026-08-25 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,951 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,206 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,643 | 🐛 820 | 🌐 C | 📅 2026-08-25 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,267 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,603 | 🐛 58 | 🌐 C++ | 📅 2026-08-25 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,798 | 🐛 212 | 🌐 Python | 📅 2026-08-24 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,345 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
...
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,207 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineer Android applications.
...
* [Zsteg](https://github.com/zed-0xff/zsteg/) ⭐ 1,617 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - PNG/BMP analysis.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,263 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
* [Commix](https://github.com/commixproject/commix) ⭐ 5,823 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Automated All-in-One OS Command Injection and Exploitation Tool.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 8,963 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
...
* [CTF Tools](https://github.com/zardus/ctf-tools) ⭐ 9,500 | 🐛 12 | 🌐 Nix | 📅 2026-08-12 - Collection of setup scripts to install various security research tools.
