...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,970 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,841 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
* [FBCTF](https://github.com/facebook/fbctf) ⚠️ Archived - Platform to host Capture the Flag competitions from Facebook.
* [SecGen](https://github.com/cliffe/SecGen) ⭐ 2,792 | 🐛 37 | 🌐 Python | 📅 2026-08-28 - Security Scenario Generator. Creates randomly vulnerable virtual machines.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 39,019 | 🐛 602 | 🌐 Ruby | 📅 2026-09-17
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,991 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,127 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - A tool for recovering RSA private key with various attack.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,640 | 🐛 515 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
* [Patator](https://github.com/lanjelot/patator) ⭐ 3,932 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,703 | 🐛 120 | 🌐 Python | 📅 2026-09-03 - CTF Framework for writing exploits.
* [ROP Gadget](https://github.com/JonathanSalwan/ROPgadget) ⭐ 4,479 | 🐛 15 | 🌐 Python | 📅 2026-06-24 - Framework for ROP exploitation.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,025 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,501 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,820 | 🐛 822 | 🌐 C | 📅 2026-09-16 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,342 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,695 | 🐛 55 | 🌐 C++ | 📅 2026-09-17 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,872 | 🐛 219 | 🌐 Python | 📅 2026-09-16 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,394 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - Runtime Mobile Exploration.
* [Angr](https://github.com/angr/angr) ⭐ 9,094 | 🐛 725 | 🌐 Python | 📅 2026-09-17 - platform-agnostic binary analysis framework.
* [GEF](https://github.com/hugsy/gef) ⭐ 8,361 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - GDB plugin.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,253 | 🐛 46 | 🌐 Python | 📅 2026-09-17 - Reverse engineer Android applications.
* [PEDA](https://github.com/longld/peda) ⭐ 6,151 | 🐛 76 | 🌐 Python | 📅 2024-07-29 - GDB plugin (only python2.7).
* [Triton](https://github.com/JonathanSalwan/Triton/) ⭐ 4,296 | 🐛 38 | 🌐 C++ | 📅 2026-09-16 - Dynamic Binary Analysis (DBA) framework.
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,094 | 🐛 6 | 🌐 Python | 📅 2026-09-17 - GDB front-end/reverse engineering tool, focused on game-hacking and automation.
...
* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,251 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - Java decompiler and disassembler.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,459 | 🐛 33 | 🌐 Python | 📅 2026-09-15 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
* [Commix](https://github.com/commixproject/commix) ⭐ 5,846 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - Automated All-in-One OS Command Injection and Exploitation Tool.
* [W3af](https://github.com/andresriancho/w3af) ⭐ 4,904 | 🐛 2,032 | 🌐 Python | 📅 2023-02-22 -  Web Application Attack and Audit Framework.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,024 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A high performance offensive security tool for reconnaissance and vulnerability scanning.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 9,047 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
...
* [CTF Tools](https://github.com/zardus/ctf-tools) ⭐ 9,516 | 🐛 2 | 🌐 Nix | 📅 2026-09-09 - Collection of setup scripts to install various security research tools.
