...
Please take a quick look at the [contribution guidelines](https://github.com/apsdehal/ctf-tools/blob/master/CONTRIBUTING.md) ⭐ 11,789 | 🐛 65 | 🌐 JavaScript | 📅 2024-07-22 first.
...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,957 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,797 | 🐛 426 | 🌐 Python | 📅 2026-08-19 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
...
* [RootTheBox](https://github.com/moloch--/RootTheBox) ⭐ 1,128 | 🐛 69 | 🌐 Python | 📅 2026-04-24 - A Game of Hackers (CTF Scoreboard & Game Manager).
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 38,848 | 🐛 610 | 🌐 Ruby | 📅 2026-08-21
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,848 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,092 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - A tool for recovering RSA private key with various attack.
* [RSATool](https://github.com/ius/rsatool) ⭐ 1,654 | 🐛 2 | 🌐 Python | 📅 2026-07-20 - Generate private key with knowledge of p and q.
* [XORTool](https://github.com/hellman/xortool) ⭐ 1,487 | 🐛 3 | 🌐 Python | 📅 2025-05-21 - A tool to analyze multi-byte xor cipher.
* [Hash Extender](https://github.com/iagox86/hash_extender) ⭐ 1,210 | 🐛 10 | 🌐 C | 📅 2025-01-27 - A utility tool for performing hash length extension attacks.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,528 | 🐛 513 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
* [Patator](https://github.com/lanjelot/patator) ⭐ 3,922 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,652 | 🐛 120 | 🌐 Python | 📅 2026-08-16 - CTF Framework for writing exploits.
...
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,344 | 🐛 2 | 🌐 Ruby | 📅 2026-08-23 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,944 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,168 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,627 | 🐛 820 | 🌐 C | 📅 2026-08-23 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,257 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,595 | 🐛 53 | 🌐 C++ | 📅 2026-08-23 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,783 | 🐛 211 | 🌐 Python | 📅 2026-08-23 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,339 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
* [Angr](https://github.com/angr/angr) ⭐ 9,027 | 🐛 678 | 🌐 Python | 📅 2026-08-23 - platform-agnostic binary analysis framework.
* [GEF](https://github.com/hugsy/gef) ⭐ 8,321 | 🐛 14 | 🌐 Python | 📅 2026-08-20 - GDB plugin.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,203 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineer Android applications.
* [PEDA](https://github.com/longld/peda) ⭐ 6,147 | 🐛 76 | 🌐 Python | 📅 2024-07-29 - GDB plugin (only python2.7).
* [Triton](https://github.com/JonathanSalwan/Triton/) ⭐ 4,272 | 🐛 38 | 🌐 C++ | 📅 2026-07-28 - Dynamic Binary Analysis (DBA) framework.
...
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,067 | 🐛 7 | 🌐 Python | 📅 2026-08-15 - GDB front-end/reverse engineering tool, focused on game-hacking and automation.
...
* [RABCDAsm](https://github.com/CyberShadow/RABCDAsm) ⭐ 456 | 🐛 4 | 🌐 D | 📅 2023-03-31 - Collection of utilities including an ActionScript 3 assembler/disassembler.
...
* [SmartDeblur](https://github.com/Y-Vladimir/SmartDeblur) ⭐ 2,413 | 🐛 13 | 🌐 C++ | 📅 2019-04-02 - Used to deblur and fix defocused images.
* [Zsteg](https://github.com/zed-0xff/zsteg/) ⭐ 1,614 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - PNG/BMP analysis.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,000 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A high performance offensive security tool for reconnaissance and vulnerability scanning.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 8,953 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
