...
Please take a quick look at the [contribution guidelines](https://github.com/apsdehal/ctf-tools/blob/master/CONTRIBUTING.md) ⭐ 11,751 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 first.
...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,951 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [SecGen](https://github.com/cliffe/SecGen) ⭐ 2,790 | 🐛 36 | 🌐 Python | 📅 2026-07-31 - Security Scenario Generator. Creates randomly vulnerable virtual machines.
...
* [echoCTF.RED](https://github.com/echoCTF/echoCTF.RED) ⭐ 149 | 🐛 23 | 🌐 PHP | 📅 2026-08-07 - Develop, deploy and maintain your own CTF infrastructure.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 38,799 | 🐛 610 | 🌐 Ruby | 📅 2026-08-13
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,785 | 🐛 43 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
...
* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,063 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - A tool for recovering RSA private key with various attack.
* [RSATool](https://github.com/ius/rsatool) ⭐ 1,649 | 🐛 2 | 🌐 Python | 📅 2026-07-20 - Generate private key with knowledge of p and q.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,496 | 🐛 512 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
...
* [ROP Gadget](https://github.com/JonathanSalwan/ROPgadget) ⭐ 4,463 | 🐛 15 | 🌐 Python | 📅 2026-06-24 - Framework for ROP exploitation.
* [Qira](https://github.com/BinaryAnalysisPlatform/qira) ⭐ 4,069 | 🐛 69 | 🌐 C | 📅 2022-07-02 - QEMU Interactive Runtime Analyser.
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,345 | 🐛 2 | 🌐 Ruby | 📅 2026-08-13 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,051 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,564 | 🐛 822 | 🌐 C | 📅 2026-08-13 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,225 | 🐛 91 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,553 | 🐛 91 | 🌐 C++ | 📅 2026-08-13 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,759 | 🐛 210 | 🌐 Python | 📅 2026-08-09 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,314 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
...
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,192 | 🐛 46 | 🌐 Python | 📅 2026-08-13 - Reverse engineer Android applications.
...
* [Zsteg](https://github.com/zed-0xff/zsteg/) ⭐ 1,606 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - PNG/BMP analysis.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,176 | 🐛 32 | 🌐 Python | 📅 2026-08-13 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
* [Commix](https://github.com/commixproject/commix) ⭐ 5,815 | 🐛 8 | 🌐 Python | 📅 2026-08-13 - Automated All-in-One OS Command Injection and Exploitation Tool.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 8,933 | 🐛 27 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
