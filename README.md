...
Please take a quick look at the [contribution guidelines](https://github.com/apsdehal/ctf-tools/blob/master/CONTRIBUTING.md) ⭐ 11,763 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 first.
...
* [Dnscat2](https://github.com/iagox86/dnscat2) ⭐ 3,953 | 🐛 98 | 🌐 PHP | 📅 2024-03-14 - Hosts communication through DNS.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,792 | 🐛 424 | 🌐 Python | 📅 2026-08-18 - Platform to host jeopardy style CTFs from ISISLab, NYU Tandon.
* [FBCTF](https://github.com/facebook/fbctf) ⚠️ Archived - Platform to host Capture the Flag competitions from Facebook.
* [SecGen](https://github.com/cliffe/SecGen) ⭐ 2,788 | 🐛 36 | 🌐 Python | 📅 2026-07-31 - Security Scenario Generator. Creates randomly vulnerable virtual machines.
* [RootTheBox](https://github.com/moloch--/RootTheBox) ⭐ 1,127 | 🐛 69 | 🌐 Python | 📅 2026-04-24 - A Game of Hackers (CTF Scoreboard & Game Manager).
...
* [echoCTF.RED](https://github.com/echoCTF/echoCTF.RED) ⭐ 149 | 🐛 22 | 🌐 PHP | 📅 2026-08-17 - Develop, deploy and maintain your own CTF infrastructure.
...
* [MotherFucking-CTF](https://github.com/andreafioraldi/motherfucking-ctf) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2019-05-29 - Badass lightweight plaform to host CTFs. No JS involved.
...
* [Metasploit JavaScript Obfuscator](https://github.com/rapid7/metasploit-framework/wiki/How-to-obfuscate-JavaScript-in-Metasploit) ⭐ 38,828 | 🐛 612 | 🌐 Ruby | 📅 2026-08-18
* [Uglify](https://github.com/mishoo/UglifyJS) ⭐ 13,380 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,812 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - Framework to perform MITM (Man in the Middle) attacks.
* [Yersinia](https://github.com/tomac/yersinia) ⭐ 863 | 🐛 29 | 🌐 C | 📅 2023-09-15 - Attack various protocols on layer 2.

## Crypto

*Tools used for solving Crypto challenges*

* [RSACTFTool](https://github.com/Ganapati/RsaCtfTool) ⭐ 7,076 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - A tool for recovering RSA private key with various attack.
* [RSATool](https://github.com/ius/rsatool) ⭐ 1,652 | 🐛 2 | 🌐 Python | 📅 2026-07-20 - Generate private key with knowledge of p and q.
* [XORTool](https://github.com/hellman/xortool) ⭐ 1,485 | 🐛 3 | 🌐 Python | 📅 2025-05-21 - A tool to analyze multi-byte xor cipher.
* [Hash Extender](https://github.com/iagox86/hash_extender) ⭐ 1,208 | 🐛 10 | 🌐 C | 📅 2025-01-27 - A utility tool for performing hash length extension attacks.
* [FeatherDuster](https://github.com/nccgroup/featherduster) ⭐ 1,137 | 🐛 28 | 🌐 Python | 📅 2021-12-02 - An automated, modular cryptanalysis tool.
* [padding-oracle-attacker](https://github.com/KishanBagaria/padding-oracle-attacker) ⭐ 216 | 🐛 7 | 🌐 TypeScript | 📅 2023-02-03 - A CLI tool to execute padding oracle attacks.
...
* [John The Jumbo](https://github.com/magnumripper/JohnTheRipper) ⭐ 13,508 | 🐛 512 | 🌐 C | 📅 2026-08-01 - Community enhanced version of John the Ripper.
* [Patator](https://github.com/lanjelot/patator) ⭐ 3,919 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design.
...
* [Pwntools](https://github.com/Gallopsled/pwntools) ⭐ 13,645 | 🐛 118 | 🌐 Python | 📅 2026-08-16 - CTF Framework for writing exploits.
* [ROP Gadget](https://github.com/JonathanSalwan/ROPgadget) ⭐ 4,465 | 🐛 15 | 🌐 Python | 📅 2026-06-24 - Framework for ROP exploitation.
* [Qira](https://github.com/BinaryAnalysisPlatform/qira) ⭐ 4,069 | 🐛 69 | 🌐 C | 📅 2022-07-02 - QEMU Interactive Runtime Analyser.
* [one\_gadget](https://github.com/david942j/one_gadget) ⭐ 2,345 | 🐛 3 | 🌐 Ruby | 📅 2026-08-18 -  A tool to find the one gadget `execve('/bin/sh', NULL, NULL)` call.
...
* [DVCS Ripper](https://github.com/kost/dvcs-ripper) ⭐ 1,781 | 🐛 11 | 🌐 Perl | 📅 2024-07-19 - Rips web accessible (distributed) version control systems.
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,935 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Mass IP port scanner, TCP port scanner.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,118 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - Decompile Android files.
* [radare2](https://github.com/radare/radare2) ⭐ 24,592 | 🐛 822 | 🌐 C | 📅 2026-08-18 - A portable reversing framework.
* [BinWalk](https://github.com/devttys0/binwalk) ⭐ 14,235 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, reverse engineer, and extract firmware images.
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,566 | 🐛 63 | 🌐 C++ | 📅 2026-08-18 - A theorem prover from Microsoft Research.
* [Pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,771 | 🐛 213 | 🌐 Python | 📅 2026-08-18 - A GDB plugin that provides a suite of utilities to hack around GDB easily.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,323 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration.
* [Angr](https://github.com/angr/angr) ⭐ 9,019 | 🐛 724 | 🌐 Python | 📅 2026-08-18 - platform-agnostic binary analysis framework.
* [GEF](https://github.com/hugsy/gef) ⭐ 8,319 | 🐛 16 | 🌐 Python | 📅 2026-06-16 - GDB plugin.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,196 | 🐛 46 | 🌐 Python | 📅 2026-08-13 - Reverse engineer Android applications.
* [PEDA](https://github.com/longld/peda) ⭐ 6,147 | 🐛 76 | 🌐 Python | 📅 2024-07-29 - GDB plugin (only python2.7).
* [Triton](https://github.com/JonathanSalwan/Triton/) ⭐ 4,267 | 🐛 38 | 🌐 C++ | 📅 2026-07-28 - Dynamic Binary Analysis (DBA) framework.
* [Plasma](https://github.com/joelpx/plasma) ⭐ 3,072 | 🐛 15 | 🌐 Python | 📅 2021-08-31 - An interactive disassembler for x86/ARM/MIPS which can generate indented pseudo-code with colored syntax.
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,060 | 🐛 6 | 🌐 Python | 📅 2026-08-15 - GDB front-end/reverse engineering tool, focused on game-hacking and automation.
* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,243 | 🐛 25 | 🌐 Rust | 📅 2026-04-07 - Java decompiler and disassembler.
* [Barf](https://github.com/programa-stic/barf-project) ⭐ 1,451 | 🐛 17 | 🌐 Python | 📅 2019-11-24 - Binary Analysis and Reverse engineering Framework.
...
* [demovfuscator](https://github.com/kirschju/demovfuscator) ⭐ 762 | 🐛 3 | 🌐 C++ | 📅 2025-05-04 - A work-in-progress deobfuscator for movfuscated binaries.
* [Apk2Gold](https://github.com/lxdvs/apk2gold) ⭐ 699 | 🐛 19 | 🌐 Shell | 📅 2024-03-05 - Yet another Android decompiler.
* [PinCTF](https://github.com/ChrisTheCoolHut/PinCTF) ⭐ 504 | 🐛 8 | 🌐 Python | 📅 2020-04-12 - A tool which uses intel pin for Side Channel Analysis.
* [Uncompyle](https://github.com/gstarnberger/uncompyle) ⚠️ Archived - Decompile Python 2.7 binaries (.pyc).
* [Boomerang](https://github.com/BoomerangDecompiler/boomerang) ⭐ 407 | 🐛 38 | 🌐 C++ | 📅 2020-12-28 - Decompile x86/SPARC/PowerPC/ST-20 binaries to C.
...
* [RABCDAsm](https://github.com/CyberShadow/RABCDAsm) ⭐ 455 | 🐛 4 | 🌐 D | 📅 2023-03-31 - Collection of utilities including an ActionScript 3 assembler/disassembler.
...
* [Zsteg](https://github.com/zed-0xff/zsteg/) ⭐ 1,609 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - PNG/BMP analysis.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,210 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - Automatic SQL injection and database takeover tool.
  `pip install sqlmap`
* [Commix](https://github.com/commixproject/commix) ⭐ 5,819 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Automated All-in-One OS Command Injection and Exploitation Tool.
* [W3af](https://github.com/andresriancho/w3af) ⭐ 4,901 | 🐛 2,031 | 🌐 Python | 📅 2023-02-22 -  Web Application Attack and Audit Framework.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,993 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A high performance offensive security tool for reconnaissance and vulnerability scanning.
...
* [Flare VM](https://github.com/fireeye/flare-vm/) ⭐ 8,942 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - Based on Windows.
...
* [CTF Tools](https://github.com/zardus/ctf-tools) ⭐ 9,495 | 🐛 12 | 🌐 Nix | 📅 2026-08-12 - Collection of setup scripts to install various security research tools.
...
* [MIPT CTF](https://github.com/xairy/mipt-ctf) ⭐ 281 | 🐛 0 | 🌐 Python | 📅 2021-12-26 - A small course for beginners in CTFs (in Russian).
...
* [Juice Shop CTF](https://github.com/bkimminich/juice-shop-ctf) ⭐ 475 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-16 - Scripts and tools for hosting a CTF on [OWASP Juice Shop](https://www.owasp.org/index.php/OWASP_Juice_Shop_Project) easily.

## Websites

*Various general websites about and on CTF*

* [Awesome CTF Cheatsheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet#awesome-ctf-cheatsheet-) ⭐ 139 | 🐛 0 | 📅 2025-04-29 - CTF Cheatsheet.
...
* [pwntools writeups](https://github.com/Gallopsled/pwntools-write-ups) ⭐ 526 | 🐛 14 | 🌐 Python | 📅 2016-10-05 - A collection of CTF write-ups all using pwntools.
...
* [Smoke Leet Everyday](https://github.com/smokeleeteveryday/CTF_WRITEUPS) ⭐ 191 | 🐛 0 | 🌐 Python | 📅 2017-10-08 - CTF write-ups repo maintained by SmokeLeetEveryday team.
* [Mzfr](https://github.com/mzfr/ctf-writeups/) ⭐ 123 | 🐛 0 | 🌐 Python | 📅 2022-07-13 - CTF competition write-ups by mzfr
* [0e85dc6eaf](https://github.com/0e85dc6eaf/CTF-Writeups) ⭐ 104 | 🐛 0 | 🌐 C | 📅 2020-02-25 - Write-ups for CTF challenges by 0e85dc6eaf
* [CTFTime Scrapper](https://github.com/abdilahrf/CTFWriteupScrapper) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2017-04-15 - Scraps all writeup from CTF Time and organize which to read first.
* [SababaSec](https://github.com/SababaSec/ctf-writeups) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - A collection of CTF write-ups by the SababaSec team
